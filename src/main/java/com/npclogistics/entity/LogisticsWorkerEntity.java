...
import com.npclogistics.ai.FisherBrain;
...
public class LogisticsWorkerEntity extends PathAwareEntity {
    ...
    private final FisherBrain fisherBrain;
    ...
    public LogisticsWorkerEntity(EntityType<? extends PathAwareEntity> type, World world) {
        ...
        fisherBrain        = new FisherBrain(this);
    ...
    public void tick() {
        ...
        if (isRoleActive()) {
            ...
            switch (activeRole()) {
                ...
                case FISHER   -> { setStepHeight(0.6f); fisherBrain.tick(sw); }
            }
            return;
        }
        if (roleWasActive) {
